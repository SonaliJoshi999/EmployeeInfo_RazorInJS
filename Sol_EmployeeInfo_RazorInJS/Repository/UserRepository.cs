using Sol_EmployeeInfo_RazorInJS.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace Sol_EmployeeInfo_RazorInJS.Repository
{
    public interface IUserRepository
    {
       ...
       // Task<IEnumerable<UserModel>> GetSingleUserDetails(int id);
    }
    public class UserRepository : IUserRepository
    {
        //async Task<IEnumerable<UserModel>> IUserRepository.GetSingleUserDetails(int id)
        //{
        //    try
        //    {
        //        var SingleUserList = new List<UserModel>();

        //        var userList = await((IUserRepository)this).GetUserDetails();
